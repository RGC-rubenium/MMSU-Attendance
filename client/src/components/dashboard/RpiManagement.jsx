...
const RpiManagement = () => {
    ...
    const unpairDevice = async (deviceId) => {
        if (!confirm('Are you sure you want to unpair this device? It will need to be re-paired to access the scanner.')) {
            return;
        }
        ...
        <div className="rpi-management">
            <div className="header">
                ...
                <div className="header-stats">
                    <div className="stat">
                        <span className="stat-value">{devices.filter(d => d.is_online).length}</span>
                        <span className="stat-label">Online</span>
                    </div>
                    <div className="stat">
                        <span className="stat-value">{devices.filter(d => d.is_enabled).length}</span>
